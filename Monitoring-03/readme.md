  ...
  "panels": [
    {
      ...
      "targets": [
        {
          "expr": "(node_filesystem_free_bytes{device=\"/dev/sda2\",fstype=\"ext4\",mountpoint=\"/\"} )/1000000000",
          "interval": "",
          "legendFormat": "",
          "refId": "A"
        }
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "100 * (1 - avg(rate(node_cpu_seconds_total{instance=\"nodeexporter:9100\", job=\"nodeexporter\", mode=\"idle\"}[1m])))",
          "instant": false,
          "interval": "",
          "legendFormat": "",
          "refId": "A"
